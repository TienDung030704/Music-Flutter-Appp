...
class NCT
{
	...
	public function getSongSearch($keyword, $page = 1, $size = 10)
	{
		...
		$url = $this->buildV1URL("search-song", $token, "keyword=" . urlencode($keyword));
		...
		if (!is_array($b) || !isset($b['Result']) || $b['Result'] != 1) {
			return false;
		}
	...
	public function getVideoSearch($keyword, $page = 1, $size = 10)
	{
		...
		$url = $this->buildV1URL("search-video", $token, "keyword=" . urlencode($keyword));
